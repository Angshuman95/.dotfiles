...
hl.config({
    ...
    group = {
        col = {
            border_active = { colors = {"rgba(b4befeff)", "rgba(cba6f7ff)"}, angle = 45 },
            border_inactive = "rgba(6c7086aa)",
        },
        ...
        groupbar = {
            ...
            col = {
                active = { colors = {"rgba(45475aff)", "rgba(45475aff)"}, angle = 90 },
                inactive = { colors = {"rgba(11111bff)", "rgba(11111bff)"}, angle = 90 },
                locked_active = { colors = {"rgba(cba6f7ff)", "rgba(cba6f7ff)"}, angle = 90 },
                locked_inactive = { colors = {"rgba(313244ff)", "rgba(313244ff)"}, angle = 90 },
            }
        }
    },
...
hl.bind(mainMod .. " + SHIFT + P", hl.dsp.exec_cmd("flameshot screen -n 0 -c"))

-- Window state
local _ = hl.bind(mainMod .. " + Y", hl.dsp.window.close())
...
hl.bind("ALT + H", hl.dsp.group.next())
hl.bind("ALT + L", hl.dsp.group.prev())
...
hl.bind("ALT + SHIFT + H", hl.dsp.group.move_window({ forward = false }))
hl.bind("ALT + SHIFT + L", hl.dsp.group.move_window({ forward = true }))
